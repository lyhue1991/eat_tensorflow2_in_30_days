...
dftrain_raw111 = pd.read_csv('./data/titanic/train.csv')
dftest_raw111 = pd.read_csv('./data/titanic/test.csv')
dftrain_raw111.head(10)
```
...
dftrain_raw,dftest_raw = train_test_split(dftrain_raw111,test_size=0.2)
```
